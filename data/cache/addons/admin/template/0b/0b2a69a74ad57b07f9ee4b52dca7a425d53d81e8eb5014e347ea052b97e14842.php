...
/* modules/lists.html */
class __TwigTemplate_46816e5d813927e16daff60b8a92d457d3bc01581d027f67dc260fe3db7b1c94 extends Twig_Template
{
...
<div class=\"admin\">
    ...
    <div class=\"aright\">
        ...
        // line 17
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["_GPC"]) ? $context["_GPC"] : null), "name", array(), "array"), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["data"]) {
            ...
            echo "                        <li data-id=\"586\">
                            <a class=\"fly-case-img\"  rel=\"nofollow\">
                                <img src=\"/";
            // line 30
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["route"]) ? $context["route"] : null), "DEFAULT_ADDONS", array()), "html", null, true);
            echo "/";
            ...
            // line 44
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["G"]) ? $context["G"] : null), "url", array(0 => "admin/modules/uninstallModules", 1 => array("dir_name" => $this->getAttribute($context["data"], "dir_name", array()))), "method"), "html", null, true);
            echo "\">卸载</a></P>
                            </div>
                        </li>
                        ";
...
<script>
    ...
    layui.use('laypage', function () {
        ...
        echo "\",
            limit: \"";
        // line 76
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "page_size", array()), "html", null, true);
        echo "\",
            curr: \"";
        // line 77
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : null), "current_page", array()), "html", null, true);
        echo "\",
            layout: ['count', 'prev', 'page', 'next', 'limit', 'skip'],
            jump: function (obj, first) {
                var url = \"";
        // line 80
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["G"]) ? $context["G"] : null), "url", array(0 => "admin/modules/modulesList", 1 => array("current_page" => "currs", "page_size" => "limit")), "method"), "html", null, true);
        echo "\";
                /**
                 * 替换处理
                 * @type {string}
    ...
    \$(\".click\").click(function () {
        ...
        var url = \"";
        // line 99
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["G"]) ? $context["G"] : null), "url", array(0 => "modules/admin/index"), "method"), "html", null, true);
        echo "\";
        /**
         * 替换处理
         * @type {string}
...
";
    ...
    {
        return new Twig_Source("", "modules/lists.html", "/data/test/calfbbs/addons/admin/template/modules/lists.html");
    }
}
