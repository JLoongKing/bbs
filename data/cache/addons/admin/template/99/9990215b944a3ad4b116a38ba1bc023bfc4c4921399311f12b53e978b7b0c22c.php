...
/* index/index.html */
class __TwigTemplate_2341dfbf7c2a01bbcfd0e3d328945f3334b1f8bbf4e8782c67db8ff20b58502b extends Twig_Template
{
    ...
    <div class=\"aright\">
        <div class=\"aright_1\">
            ...
            <table width=\"100%\">
                ...
                <tr><td>服务器类型</td><td>";
        // line 25
        echo twig_escape_filter($this->env, (isset($context["PHP_UNAME"]) ? $context["PHP_UNAME"] : null), "html", null, true);
        echo "</td></tr>
                <tr><td>PHP版本</td><td>";
        // line 26
        ...
        echo "</td></tr>
                <tr><td>Zend版本</td><td>";
        // line 27
        echo twig_escape_filter($this->env, (isset($context["Zend_Version"]) ? $context["Zend_Version"] : null), "html", null, true);
        echo "</td></tr>
                <tr><td>服务器解译引擎</td><td>";
        // line 28
        echo twig_escape_filter($this->env, (isset($context["SERVER_SOFTWARE"]) ? $context["SERVER_SOFTWARE"] : null), "html", null, true);
        echo "</td></tr>
                <tr><td>服务器语言</td><td>";
        // line 29
        echo twig_escape_filter($this->env, (isset($context["HTTP_ACCEPT_LANGUAGE"]) ? $context["HTTP_ACCEPT_LANGUAGE"] : null), "html", null, true);
        echo "</td></tr>
                <tr><td>服务器Web端口</td><td>";
        // line 30
        echo twig_escape_filter($this->env, (isset($context["SERVER_PORT"]) ? $context["SERVER_PORT"] : null), "html", null, true);
        echo "</td></tr>
            </table>
...
";
    ...
    {
        return new Twig_Source("", "index/index.html", "/data/test/calfbbs/addons/admin/template/index/index.html");
    }
}
