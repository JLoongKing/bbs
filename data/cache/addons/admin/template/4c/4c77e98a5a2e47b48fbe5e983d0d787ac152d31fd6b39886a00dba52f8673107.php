...
class __TwigTemplate_b3f112cb219eeeb83a4583f38760915a60091ae02a05f59ce1100aa038e6c37c extends Twig_Template
{
    ...
    <ul class=\"cl\">
        ...
        // line 4
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["G"]) ? $context["G"] : null), "url", array(0 => "admin/setting/configure", 1 => "t=configure"), "method"), "html", null, true);
        echo "\">网站设置</a></li>
       <!--<li><i class=\"layui-icon\">&#xe601;</i><a href=\"";
        // line 5
        ...
        <li><i class=\"layui-icon\">&#xe631;</i><a href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["G"]) ? $context["G"] : null), "url", array(0 => "admin/setting/password", 1 => "t=configure"), "method"), "html", null, true);
        echo "\">修改密码</a></li>
    ...
    {
        return new Twig_Source("", "common/settingNav.html", "/data/test/calfbbs/addons/admin/template/common/settingNav.html");
    }
}
